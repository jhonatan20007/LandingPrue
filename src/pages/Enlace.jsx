...
import { brainwaveServices, EnlaceServices } from "../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
        ...
        <div className="relative">
          <div className="relative z-1 flex items-start h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-10 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
                style={{width:"40%", height:"45%",marginLeft:"15%"}}
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              <h4 className="h4 mb-4">Genera tus enlaces</h4>
              <p className="body-2 mb-[3rem] text-n-1/80">
                Con el Modulo Admin de Ipaid, puedes generar enlaces de pago
                personalizados para tus clientes.
              </p>
              <ul className="body-2">
                {EnlaceServices.map((item, index) => (
                  <li
                    key={index}

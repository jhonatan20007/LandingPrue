...
import { brainwaveServices, brainwaveServicesIcons, PagosServices } from "../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
          ...
          <div className="relative z-1 flex items-start h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-1/80">
                Ipaid es una plataforma de pagos que permite a los usuarios
                realizar transacciones de manera rápida e intuitiva.
              </p>
              <ul className="body-2">
                {PagosServices.map((item, index) => (
                  <li
                    key={index}
